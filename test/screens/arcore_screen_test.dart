...
void main() {
  ...
  testWidgets('ARCoreScreen (Control Panel)', (WidgetTester tester) async {
    ...
    await tester.ensureVisible(targetFingerDropdownFinder);
    await tester.pumpAndSettle();
    expect(targetFingerDropdownFinder, findsOneWidget);

    final dropdownWidget = tester.widget<DropdownButton<String>>(targetFingerDropdownFinder);
    ...
    // Close
    final closeSettingsButtonFinder = find.byIcon(Icons.close); 
    await tester.ensureVisible(closeSettingsButtonFinder);
    await tester.tap(closeSettingsButtonFinder);
    await tester.pumpAndSettle();
  });
  ...
  testWidgets('ARCoreScreen (Reload Model)', (WidgetTester tester) async {
    ...
    final reloadButtonFinder = find.widgetWithIcon(FloatingActionButton, Icons.refresh);
    await tester.ensureVisible(reloadButtonFinder);
    final refreshBtn = tester.widget<FloatingActionButton>(reloadButtonFinder);
